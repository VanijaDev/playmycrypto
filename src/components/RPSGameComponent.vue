  ...
  <div>
    <div class="row game-block" id="rpsstart">
      ...
      <div class="col-sm-8 border-left text-center inner-column second-inner-column">
        ...
        <div class="mb-sm-0 mb-3">
          <button
            class="btn btn-link game-move-item mr-4 mr-sm-5 ml-sm-4"
          ...
          <button
            class="btn btn-link game-move-item mr-4 ml-2 mr-sm-5 ml-sm-5"
          ...
          <button
            class="btn btn-link game-move-item mr-1 ml-2 mr-sm-5 ml-sm-5"
            v-bind:class="{active: gameValue===3}"
            @click="selectMoveValue(3)"
          >
            <img src="/img/game-icon-scissor-big.svg" v-if="gameValue!==3" />
    ...
    <div class="row game-block hidden" id="rpswfopponent">
      ...
      <div class="col-sm-8 border-left text-center inner-column">
        ...
        <div
          id="rpswfopponent_makeTop_block"
          class="align-button-bottom hidden"
          data-group="rpswfopponent_make_top"
        >
          <button
        ...
        <div
          id="rpswfopponent_paused_block"
          class="mt-5 pt-5 hidden"
          data-group="rpswfopponent_paused"
        >
      ...
      <div class="col-sm-4 f13 info-column inner-column opacity-text">
        <div class="mt-0 pt-2 text-left opacity-text">
          ...
          <button
            ...
            onclick="window.Game.rps_joinGameClicked()"
          >
            <img src="/img/icon-btn-start.svg" class="mr-2" />
            {{ $t('JOIN_GAME') }}
          </button>
      ...
      <div class="col-sm-4 f13 info-column inner-column opacity-text">
        <div class="mt-1 pt-2 text-left opacity-text">
          ...
          <div class="bottom-buttons row">
            <div class="col-5 offset-1">
              <button
                id="rpswfopponentmove_quit_btn"
                class="btn btn-small-orange disabled"
                onclick="window.Game.quitGameClicked()"
              >{{ $t('QUIT_GAME') }}</button>
            </div>
            <div class="col-5 pr-2 button-border-left">
              <button
                id="rpswfopponentmove_claim_expired_btn"
                class="btn btn-small-orange disabled"
                onclick="window.Game.rps_claimExpiredGameClicked()"
              >{{ $t('CLAIM_EXPIRED') }}</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row game-block hidden" id="rpscreatormove">
      <div class="col-sm-4 f13 info-column inner-column opacity-text">
        <div class="mt-1 pt-2 text-left opacity-text">
          ...
          <button
            id="rpscreatormove_play_move_btn"
            class="btn btn-start-game desktop-move mb-3"
            v-bind:class="{disabled: playMoveDisabled}"
            onclick="window.Game.rps_playMoveClicked()"
          >
            <img src="/img/icon-btn-start.svg" class="mr-2" />
            {{ $t('PLAY_MOVE') }}
          </button>
          ...
          <div class="bottom-buttons row">
            ...
            <div class="col-5 pr-2 button-border-left">
              <button
                id="rpscreatormove_claim_expired_btn"
                class="btn btn-small-orange disabled"
                onclick="window.Game.rps_claimExpiredGameClicked()"
              >{{ $t('CLAIM_EXPIRED') }}</button>
            </div>
      ...
      <div class="col-sm-8 border-left text-center inner-column second-inner-column">
        ...
        <div
          id="rpscreatormove_prev_next_move_creator_block"
          class="hidden"
          data-group="creatorMove"
        >
          <div class="row mt-5">
            ...
            <div class="col-sm-6">
              <div class="text-sm-left text-center">
                <button
                  class="btn btn-link game-move-item game-move-small mr-4"
                  v-bind:class="{active: prevGameValue===11}"
                  @click="selectPreviousValue(11)"
                >
                  <img src="/img/game-icon-rock-big.svg" v-if="prevGameValue!==11" />
                  <img src="/img/game-icon-rock-white.svg" v-if="prevGameValue===11" />
                </button>
                <button
                  class="btn btn-link game-move-item game-move-small mr-4 ml-3"
                  v-bind:class="{active: prevGameValue===12}"
                ...
                <button
                  class="btn btn-link game-move-item game-move-small ml-3"
                  v-bind:class="{active: prevGameValue===13}"
                  @click="selectPreviousValue(13)"
                >
              ...
              <div class="opacity-text mt-3 pl-3 pr-3 pl-sm-0 pr-sm-0">
                ...
                <input
                  type="text"
                  id="rpscreatormove_previous_move_seed"
                  class="game_view-value referral-addr"
                />
              </div>
            </div>
          ...
          <div id="rpscreatormove_next_move_action" class="row mt-5">
            ...
            <div class="col-sm-6">
              <div class="text-sm-left text-center">
                <button
                  class="btn btn-link game-move-item game-move-middle mr-4"
                  v-bind:class="{active: gameValue===1}"
                  @click="selectMoveValue(1)"
                >
                  <img src="/img/game-icon-rock-big.svg" v-if="gameValue!==1" />
                ...
                <button
                  class="btn btn-link game-move-item game-move-middle mr-4 ml-3"
                  v-bind:class="{active: gameValue===2}"
                  @click="selectMoveValue(2)"
                >
                  <img src="/img/game-icon-paper-big.svg" v-if="gameValue!==2" />
                ...
                <button
                  class="btn btn-link game-move-item game-move-middle ml-3"
                  v-bind:class="{active: gameValue===3}"
                  @click="selectMoveValue(3)"
                >
                  <img src="/img/game-icon-scissor-big.svg" v-if="gameValue!==3" />
    ...
    <div class="row game-block hidden" id="rpsopponentmove">
      <div class="col-sm-4 f13 info-column inner-column opacity-text">
        <div class="mt-1 pt-2 text-left opacity-text">
          ...
          <button
            id="rpsopponentmove_make_move_btn"
            class="btn btn-start-game desktop-move mb-3"
            onclick="window.Game.rps_makeMoveClicked()"
          >
            <img src="/img/icon-btn-start.svg" class="mr-2" />
            {{ $t('MAKE_MOVE') }}
          </button>
          ...
          <div class="bottom-buttons row">
            ...
            <div class="col-5 pr-2 button-border-left" id="claimExpiredButton">
              <button
                id="rpsopponentmove_claim_expired_btn"
                class="btn btn-small-orange disabled"
                onclick="window.Game.rps_claimExpiredGameClicked()"
              >{{ $t('CLAIM_EXPIRED') }}</button>
            </div>
...
export default {
  ...
  methods: {
    selectMoveValue(value) {
      ...
      window.Game.rps_moveClicked(value);
    },
