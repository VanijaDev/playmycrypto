<template>
  <div>
            ...
            <div class="user-profile position-relative">
              ...
              <div class="profile-info position-relative" v-click-outside="hideUserPopup">
                ...
                <div class="pointer float-left mr-2">
                  <img src="/img/notification.svg" class="notification hidden" id="profileNotification">
    ...
    <div
      ...
      v-bind:data-err_only_single_game_as_creator="$t('ONLY_SINGLE_GAME_AS_CREATOR')"
      v-bind:data-err_only_single_game_as_opponent="$t('ONLY_SINGLE_GAME_AS_OPPONENT')"
