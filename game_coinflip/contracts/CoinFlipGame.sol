...
contract CoinFlipGame is Pausable, Partnership, GameRaffle {
     ...
     * 
     */
    function joinGame(uint256 _id, address _referral) external payable whenNotPaused onlyAvailableToJoin onlyCorrectReferral(_referral) {
     ...
     * 
     */
    function increaseBetForGameBy(uint256 _id) external payable whenNotPaused onlyCreator(_id){
